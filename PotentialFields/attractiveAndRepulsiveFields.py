...
class AttractiveAndRepulsiveFields():
    ...
    def generateAttractiveAndRepulsiveFieldGraph(self):
    ...
    def __init__(self, goals, obstacles):
        ...
        # do stuff
        self.generateAttractiveAndRepulsiveFieldGraph()
    #------------------------------------------------------------


if __name__ == "__main__":
    # TEST CASE runs when this file is run individually.
    AttractiveAndRepulsiveFields([Goal.Goal(0, 0, 1, 2)], [Obstacle.Obstacle(2, 1.5, 1, 2)])